...
public class TicTacToe4 implements Game {
	...
	//make Position into a privtae inner class
	...
	public boolean isADraw() {
		return !isWin(HUMAN)&&!isWin(COMPUTER)&&boardIsFull();
	}
	...
	public String toString() {
		...
		for (int row = 0; row < 3; row++) {
			for (int col = 0; col < 3; col++) {
				...
				case TicTacToe4.HUMAN:
					spot = " " + humanSide + " ";
					break;
				case TicTacToe4.COMPUTER:
					spot = " " + computerSide + " ";
					break;
				case TicTacToe4.EMPTY:
					spot = "   ";
					break;
				default:
	...
	private int positionValue() {
		return isWin(COMPUTER) ? COMPUTER_WIN : isWin(HUMAN) ? HUMAN_WIN : boardIsFull() ? DRAW : UNCLEAR;
	}
}
